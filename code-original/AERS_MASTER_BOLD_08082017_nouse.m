...
setenv('SUBJECTS_DIR', '/Volumes/OSAbackup/BOLDtest/FREESURFER')


global SUBJECTS_DIR
SUBJECTS_DIR = '/Volumes/OSA_BOLD/FREESURFER/'
% SUBJECTS_DIR = '/Volumes/OSAbackup/BOLDtest/FREESURFER/'
...
% subject_dir = pwd;
% session_dir = fullfile(pwd,'BOLDs');
% [~,subject_name,~] = fileparts(subject_dir); % Freesurfer subject name
...
%sort_nifti(session_dir,fullfile('/Volumes/OSA_BOLD/DICOM/',Visit,subject_name,'DCM'),0,0);
sort_nifti(session_dir,fullfile(subject_dir,'dicom'),0,0);
...
%make_fieldmap(session_dir,subject_name,fullfile('/Volumes/EXPLORE:OSA/OSA/DICOM/',Visit,subject_name,'DCM'));
make_fieldmap(session_dir,subject_name,fullfile(subject_dir,'dicom'));
